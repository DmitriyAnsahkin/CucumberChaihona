...
//        webElement.click();
    ...
    new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(xpath))));
    }

    public WebElement getWebElement(String xpath){
    return new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(xpath))));
    }
    public WebElement getWebElement(WebElement webElement){
    return new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOf(webElement));
    }
